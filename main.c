...
int main(int argc, char *argv[]) {
  ...
  if (!pipeline || !source || !demuxer
      ...
      || !img_dec || !queue_img || !f_colorspace || !img_sink)
    {
  ...
  gst_bin_add_many(GST_BIN(pipeline), source, demuxer, queue_aud, aud_dec, queue_img, img_dec, f_colorspace, f_audioconv, aud_sink, img_sink, NULL);
  ...
  gst_element_link_many(queue_img, img_dec, f_colorspace, img_sink, NULL);
